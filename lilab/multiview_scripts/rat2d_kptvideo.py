...
def plot_video(video, pts2d_black, pts2d_white):
    ...
    for iframe in tqdm.tqdm(range(len(vid))):
        frame, pts2d_b_now, pts2d_w_now = vid[iframe], pts2d_black[iframe], pts2d_white[iframe]
...
if __name__ == '__main__':
    ...
    parser.add_argument('mat_file_black', type=str, default=mat_file_black, help='mat file of black points')
    parser.add_argument('mat_file_white', type=str, default=mat_file_white, help='mat file of white points')
