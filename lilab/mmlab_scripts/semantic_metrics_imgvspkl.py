# python -m lilab.mmlab_scripts.semantic_metrics_imgvspkl xxx.pkl --anno_folder xxx
# %%
import mmcv
import os
...
pred_pkl = '/home/liying_lab/chenxinfeng/DATA/mmsegmentation/seg_pkl/bw_rat_800x600_0118_cross_val/data.pkl'
anno_folder = '/home/liying_lab/chenxinfeng/DATA/mmsegmentation/data_seg/rats/annotations/test'

# %%
def calculate_matrics(pred_pkl, anno_folder):
    pred_filename_pkl = osp.dirname(pred_pkl) + '/data_filename.pkl'
    imgfiles = mmcv.load(pred_filename_pkl)
    pred_mask = mmcv.load(pred_pkl)
    # %%
...
if __name__ == '__main__':
    ...
    parser.add_argument('pred_pkl', type=str, default=pred_pkl, help='The prediction file')
    parser.add_argument('--anno_folder', type=str, default=anno_folder, help='The annotation file')
    args = parser.parse_args()
    calculate_matrics(args.pred_pkl, args.anno_folder)