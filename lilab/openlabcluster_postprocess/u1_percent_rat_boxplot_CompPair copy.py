...
groupFile=get_assert_1_file(osp.join(project,'rat_info/*rat_info*.xlsx'))
rat_info=pd.read_excel(groupFile,sheet_name='rat_info',engine='openpyxl')
video_info=pd.read_excel(groupFile,sheet_name='熊组合作D55_WT',engine='openpyxl')
...
X_lda = PCA(n_components=10).fit_transform(freq_data)
