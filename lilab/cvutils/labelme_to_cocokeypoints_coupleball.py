...
# python -m lilab.cvutils.labelme_to_cocokeypoints_coupleball /A/B/C
...
LCC.bodyparts = ["ball1", "ball2"]
LCC.TemplateKeypointList = [
    {"label": i, "points": [[0, 0]], "shape_type": "point"} for i in LCC.bodyparts
]
