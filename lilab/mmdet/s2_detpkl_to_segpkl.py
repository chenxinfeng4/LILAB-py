# %%python -m lilab.mmlab_scripts.s2_detpkl_to_segpkl
# ls *.pkl | xargs -n 1 -P 6 python -m lilab.mmdet.s2_detpkl_to_segpkl --detpkl
import pickle
import cv2
...
def convert(detpkl):
    ...
    for frame, frame_out in zip(tqdm.tqdm(data), outdata):
