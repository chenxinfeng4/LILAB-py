...
# %%python -m lilab.mmdet.extract_seperate_frames_byboxIOU_random $video_path #--iou_th 0.1 --extract_frame_num 20
# ls *segpkl | sed 's/segpkl/mp4/' | xargs -n 1 -I {} python -m lilab.mmdet.t2_finetune_extract_seperate_frames_random {} --iou_th 0.1 --extract_frame_num 20
...
def extraction(args):
    ...
    frame_path=osp.join(path,'frames_seperate')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--extract_frame_num', type=int, default=20)
