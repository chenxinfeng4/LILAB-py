...
import ffmpegcv
import ffmpegcv.ffmpeg_reader_hflip
...
video_path = ['/mnt/liying.cibr.ac.cn_Data_Temp/multiview-large/wtxwt_social/clips/2022-04-25_15-44-04_bwt_wwt_00time.mp4']
config = '/home/liying_lab/chenxinfeng/DATA/mmpose/hrnet_w32_coco_udp_rattopdown_1280x800.py'
pos_views = get_view_xywh()
hflips = get_view_hflip()
num_gpus = min([torch.cuda.device_count()*2, len(get_view_xywh())])
...
# class MyWorker:
    ...
    def compute(self, args):
        ...
        vid = FFmpegReaderHFlip.VideoReader(video, 
                                    resize=image_size,
        ...
        for i, (frame, segdata_now) in enumerate(zip(tqdm.tqdm(vid,position=int(self.id), 
            ...
            for iclass in range(nclass):
                ...
                if hflip:
                    maskcuda = torch.fliplr(maskcuda)
...
if __name__ == '__main__':
    ...
    # worker.compute(('/mnt/liying.cibr.ac.cn_Data_Temp/multiview-large/wtxwt_social/clips/2022-04-25_16-18-25_bwt_wwt_00time.mp4', 1))
