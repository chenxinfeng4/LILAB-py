# python -m lilab.mmpose.caliball_topdown_video2pkl_trt
# %%
import argparse
import os
import re
...
from lilab.multiview_scripts_new.s1_mmposepkl2matpkl import convert as convert2matpkl

video_path = ['/mnt/liying.cibr.ac.cn_Data_Temp/multiview-large/wtxwt_social/ball/2022-04-25ball.mp4']
config = '/home/liying_lab/chenxinfeng/DATA/mmpose/hrnet_w32_coco_ball_512x512.py'
# checkpoint = '/home/liying_lab/chenxinfeng/DATA/mmpose/demo/hrnet_w32_coco_ball_512x512_trt16.pth'
