...
'''
keypoint_cls = ['nose','earL', 'earR', 'neck', 'body', 'tail','shoulderL', 'palmL', 'shoulderR','palmR','kneeL','footL','kneeR',  'footR']
...
labelme_dir = '/DATA/chenxinfeng/dataset/rat_keypoints/2022-06-13-lessfullblack-bwrat_side6-kp_ok'
