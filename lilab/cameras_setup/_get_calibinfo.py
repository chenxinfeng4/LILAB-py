...
def get_ballglobal_cm_1():
    fitball_xyz_global_1 =  np.array([[0, 0, 0],
                                [0, 22, 0],
                                [22, 22, 0],
                                [22, 0, 0],[0, 0, 30],
                                [0, 22, 30],
                                ...
                                [0, 0, 105],
                                [0, 0, 15]], dtype=np.float32)
    return fitball_xyz_global_1
def get_checker_cm():
    fitchecker_xyz_global =  np.array([[0, 0, 0],
                                [0, 22, 0],
                                [22, 22, 0],
                                [22, 0, 0],
                                [0, 0, 15],
                                ...
                                [22, 22, 90],
                                [22, 0, 90],
                                [0, 0, 105]], dtype=np.float32)
    return fitchecker_xyz_global
