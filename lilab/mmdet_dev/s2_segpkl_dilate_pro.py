...
def convert(segpkl, idx=0):
    ...
    segout = [[[[None,None] for _ in range(nclass)] for _ in range(nframe)] for _ in range(nview)]
    ...
    def worker(iview):
        ...
        for iframe in range(nframe):
            ...
            for iclass in range(nclass):
                ...
                outiview[iframe][iclass] = mask_util.encode(np.asfortranarray(mask_dilate))
        return outiview
