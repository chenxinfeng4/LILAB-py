...
def plot_video(video,iview,crop_xywh, pts2d_black, pts2d_white):
    ...
    for frame, pts2d_b_now, pts2d_w_now in zip(tqdm.tqdm(vid), pts2d_black, pts2d_white):
...
def main(kptpkl='',iview=0):
    ...
    plot_video(video, iview, crop_xywh, pts2d_black, pts2d_white)
...
if __name__ == '__main__':
    ...
    main(kptpkl=args.kptpkl, iview=args.iview)
