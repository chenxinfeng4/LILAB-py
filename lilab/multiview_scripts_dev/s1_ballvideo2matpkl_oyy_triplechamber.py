# python -m lilab.multiview_scripts_dev.s1_ballvideo2matpkl_oyy_triplechamber  /mnt/liying.cibr.ac.cn_Data_Temp/multiview_9/VPAxWT/DAY75/SOLO/
# %%
import argparse
import os
import numpy as np
...
config = '/home/liying_lab/chenxinfeng/DATA/mmpose/res50_coco_com2d_512x320_threechamber_oyy.py'
...
class DataSet(OldDataSet): 
    def __init__(self, vid, cfg, views_xywh, c_channel_in=1):
        ...
        self.coord_NCHW_idx_ravel = self.coord_N1HW_idx_ravel
...
class MyWorker():
    ...
    def compute(self, args):
        ...
        vid = ffmpegcv.VideoCaptureNV(video_file, pix_fmt='gray', crop_xywh=canvas_xywh.tolist(), 
        ...
        #with torch.cuda.device("cuda:3" if torch.cuda.is_available() else "cpu"):
            trt_model = TRTModule()
        ...
        outmatlab = os.path.splitext(video_file)[0] + '.mat'
        outdict = dict(
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pannels', default='els', help='crop views')
