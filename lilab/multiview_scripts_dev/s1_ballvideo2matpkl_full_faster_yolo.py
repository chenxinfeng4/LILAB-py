# python -m lilab.multiview_scripts_dev.s1_ballvideo2matpkl_full_faster_oyy  /mnt/liying.cibr.ac.cn_Data_Temp/multiview_9/zhangyuanqing/behavior/2023-12-01_14-37-17WH_PHO_86.mp4
import argparse
import os
import numpy as np
import tqdm
...
class MyWorker():
    ...
    # def compute(self, args):
        image_size, video_file, checkpoint, views_xywh = args
    #     cfg = mmcv.Config.fromfile(config)
        feature_in_wh = np.array(image_size)
        ...
        vid = ffmpegcv.VideoCaptureNV(video_file, pix_fmt='rgb24', crop_xywh=canvas_xywh.tolist(), 
                                      ...
                                      gpu=self.cuda)
        c_channel_in=1 if vid.d=='nv12' else 3
        cfg = Cfg()
        cfg.data_cfg['image_size'] = feature_in_wh
