# python -m lilab.multiview_scripts_dev.p0_intrinsicsCalibrator A/B/C --board_size 11 8
#%%
import cv2
import numpy as np
import glob
...
def calibrate_nview(prj_imgfolder):
    ...
    with Pool(processes=min(4, len(imageFolders))) as pool:
        result = pool.map(calibration, imageFolders)
