# python -m lilab.multiview_scripts_dev.s1_ballvideo2matpkl_full_faster  /mnt/liying.cibr.ac.cn_Data_Temp/LS_NAC_fiberphotometry/1stBatch_NAC/ball/cleaned --config /home/liying_lab/chenxinfeng/DATA/mmpose/res50_coco_ball_512x320_cam9.py
# %%
import argparse
import os
import numpy as np
...
config_dict = {9:'/home/liying_lab/chenxinfeng/DATA/mmpose/res50_coco_ball_512x320_cam9.py'}
#%%
class DataSet(OldDataSet): 
    ...
    def __iter__(self):
        vread = {1:self.vid.read, 3:self.vid.read}[self.c_channel_in]
        while True:
            ret, img = vread()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pannels', default=9, help='crop views')
