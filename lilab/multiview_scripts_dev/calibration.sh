...
vfile=/home/liying_lab/chenxinfeng/ftp.image_ZYQ/multiview_large/ball_only/20221118/2022-11-17_18-45-39ball

python -m lilab.multiview_scripts_dev.s1_ballvideo2matpkl_full_faster $vfile.mp4 --pannels 9

python -m lilab.multiview_scripts_dev.s2_matpkl2ballpkl $vfile.matpkl  --time  9 15 21 27 39
