# python -m lilab.multiview_scripts_new.s2_matpkl2ballpkl ../data/matpkl/ball.matpkl --time 1 12 24 35 48
import pickle
import numpy as np
import argparse
...
def convert(matfile, global_time):
    ...
    print('python -m lilab.multiview_scripts_new.s3_ballpkl2calibpkl',
            "{}".format(outfile))
    return outfile
